    ...
    <section className="bg-ink py-24 md:py-32">
      <div className="container grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          ...
          <h2 className="font-serif text-3xl md:text-5xl leading-[1.1] text-bone" data-reveal>
        ...
        <div className="lg:col-span-6 lg:col-start-7 space-y-6">
          <p className="text-bone/75 text-lg leading-relaxed font-light" data-reveal>
          ...
          <p className="text-bone/65 leading-relaxed" data-reveal>
      ...
      <div className="container grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-4 space-y-12">
          <div data-reveal>
            ...
            <h3 className="font-serif text-2xl mb-4 text-bone">Specialist Counsel</h3>
            <p className="text-bone/65 leading-relaxed text-sm mb-6">
            ...
            <Link to="/team" className="font-mono text-xs uppercase tracking-[0.18em] text-bone underline underline-offset-8 decoration-gold decoration-2 hover:decoration-bone transition-all">
              Meet the Team →
            </Link>
          </div>
          ...
          <div data-reveal>
            ...
            <h3 className="font-serif text-2xl mb-4 text-bone">Where We Are</h3>
            <p className="text-bone/75 font-mono text-sm leading-relaxed uppercase tracking-wider">
        ...
        <div className="lg:col-span-7 lg:col-start-6">
          ...
          <h2 className="font-serif text-4xl mb-12 text-bone" data-reveal>Ethos</h2>
          ...
          <ul className="space-y-8" data-stagger>
            {[
              ...
              <li key={i} data-stagger-item className="flex items-start gap-4 border-t border-bone/10 pt-6">
                <span className="font-mono text-gold shrink-0 mt-1">0{i+1}</span>
                <span className="font-serif text-xl md:text-2xl text-bone/80">{item.t}</span>
              </li>
            ))}
          </ul>
        </div>
