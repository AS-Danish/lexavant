...
export const ThreeHero = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        style={{ y, opacity }}
        className="relative z-20 h-full flex flex-col justify-center px-6 md:px-12 lg:px-24"
      >
        <div className="max-w-5xl">
          <p className="font-mono text-[11px] uppercase tracking-[0.3em] text-ink/60 mb-8">
            About Lexavant
          </p>
          <h1 ref={headlineRef} className="font-serif text-5xl md:text-8xl lg:text-[7rem] leading-[1.1] text-ink mb-10">
            <span className="block">{splitText("Law, Finance &")}</span>
            <span className="block italic text-gold-deep">{splitText("Technology.")}</span>
          </h1>
          <p className="text-xl md:text-2xl text-ink/70 max-w-2xl font-light leading-relaxed">
