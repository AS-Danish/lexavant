    ...
    <section id="about" className="bg-ink py-28 md:py-40">
      <div className="container grid lg:grid-cols-12 gap-12 items-end">
        ...
        <div className="lg:col-span-6 lg:col-start-7 space-y-6">
          ...
          <a href="#lawyers" data-reveal className="inline-block font-mono text-xs uppercase tracking-[0.18em] text-bone underline underline-offset-8 decoration-gold decoration-2 hover:decoration-bone transition-all">
            Meet the Counsel →
          </a>
        </div>
      </div>
      ...
      <div className="container mt-24 grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-8">
          <blockquote className="font-serif italic text-2xl md:text-3xl leading-snug text-bone" data-reveal>
            &ldquo;The law is reason, free from passion.&rdquo;
            <footer className="mt-4 font-mono text-[10px] not-italic uppercase tracking-[0.3em] text-bone/50">— Aristotle</footer>
          </blockquote>
          <div className="grid grid-cols-2 gap-6 pt-6 border-t border-bone/15" data-stagger>
            {[
              ...
              <div key={s.l} data-stagger-item>
                <div className="font-serif text-xl text-bone">{s.k}</div>
                <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-bone/55 mt-1">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
