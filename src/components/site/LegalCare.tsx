...
export const LegalCare = () => {
  return (
    <section id="legal-care" className="bg-bone-soft py-28 md:py-40">
      <div className="container grid lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-6 lg:col-start-7 space-y-px" data-stagger>
          {pillars.map((p, i) => (
            <div key={p.k} data-stagger-item className="group bg-bone p-8 md:p-10 border border-ink/10 hover:border-gold/60 transition-colors duration-500">
              <div className="flex items-baseline justify-between gap-6 mb-4">
                <h3 className="font-serif text-3xl md:text-4xl text-ink">{p.k}</h3>
                <span className="font-mono text-[10px] uppercase tracking-[0.25em] text-ink/40">0{i + 1} / 03</span>
              </div>
